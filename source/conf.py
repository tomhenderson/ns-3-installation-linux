...
html_title = 'Linux installation guide'
...
latex_documents = [
  ('index', 'ns-3-installation-linux.tex', u'ns-3 Linux Installation Guide',
...
man_pages = [
    ('index', 'ns-3-linux-isntallation', u'ns-3 Linux Installation',
     [u'ns-3 project'], 1)
]
